        ...
        if len(sales_qs) > 0:
            ...
            for sale in sales_qs:
                for pos in sale.get_positions():
                    ...
                    positions_qs.append(obj)
            positions_df = pd.DataFrame(positions_qs)
            ...
            sales_df.rename({'customer_id':'customer', 'salesman_id':'salesman', 'id':'sales_id'}, inplace=True, axis=1)
            ...
            no_data = 'No Data is present for selected Data Range.'
    context = {
